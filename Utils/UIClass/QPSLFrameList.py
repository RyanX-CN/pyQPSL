...
class QPSLFrameList(QPSLFrame):
    ...
    def set_orientation(self, orientation: Qt.Orientation):
        ...
        self.setLayout(QPSLBoxLayout(orientation=orientation)().load_attr())
...
class QPSLHFrameList(QPSLFrameList):
...
class QPSLVFrameList(QPSLFrameList):
...
def make_QPSLFrameList_class(orientation: Qt.Orientation):
    if orientation == Qt.Orientation.Horizontal:
        return QPSLHFrameList
    else:
        return QPSLVFrameList